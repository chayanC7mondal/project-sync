...
const NotificationCenter: React.FC = () => {
  ...
  const [filter, setFilter] = useState<"all" | "unread" | "high" | "urgent">(
    "all"
  );
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {stats.completedHearings}
                </div>
                <div className="text-sm text-gray-600">Completed</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">
                  {stats.totalAbsenceReasons}
                </div>
      ...
      <Tabs defaultValue="notifications" className="space-y-4">
        ...
        <TabsContent value="notifications">
          ...
          <div className="flex gap-2 mb-4">
            <Select
              value={filter}
              onValueChange={(value: "all" | "unread" | "high" | "urgent") =>
                setFilter(value)
              }
            >
...
const AdminDashboard: React.FC<{ stats: NotificationStats | null }> = ({
  stats,
}) => (
  <Alert>
    <Users className="h-4 w-4" />
    <AlertDescription>
      <strong>Admin Dashboard:</strong> You can view all system notifications,
      manage user alerts, and monitor notification statistics. Use the triggers
      in Quick Actions to manually send notifications.
    </AlertDescription>
  </Alert>
);
...
const IODashboard: React.FC = () => (
  <Alert>
    ...
    <AlertDescription>
      <strong>Investigating Officer:</strong> You will receive hearing
      reminders, attendance alerts, and escalation notifications. Submit absence
      reasons if you miss hearings to avoid disciplinary action.
    </AlertDescription>
  </Alert>
);
...
const LiaisonDashboard: React.FC = () => (
  <Alert>
    ...
    <AlertDescription>
      <strong>Liaison Officer:</strong> Monitor today's hearings, track
      attendance, and receive real-time updates when witnesses mark their
      attendance via QR codes or manual entry.
    </AlertDescription>
  </Alert>
);
...
const WitnessDashboard: React.FC = () => (
  <Alert>
    ...
    <AlertDescription>
      <strong>Witness:</strong> You will receive hearing reminders and
      attendance confirmations. Make sure to mark your attendance on hearing
      days and submit reasons if you cannot attend.
    </AlertDescription>
  </Alert>
);
...
const DefaultDashboard: React.FC = () => (
  <Alert>
    ...
    <AlertDescription>
      Welcome to the Court Management System notification center. You will
      receive relevant updates and reminders based on your role and case
      involvement.
    </AlertDescription>
  </Alert>
);
